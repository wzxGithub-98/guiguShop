<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="showInfo()">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="showSupports()">
      <div class="discounts-left">
        <div class="activity activity-green" style="margin-top: 10px;">
          <span class="content-tag">
    ...
    <!--展示商家信息-->
    <div class="shop-brief-modal" v-show="this.isShowInfo">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="showInfo()">
    ...
    <!--展示优惠活动-->
    <div class="activity-sheet" v-show="this.isShowSupports">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">优惠活动</h2>
        <ul class="list">
          <li class="activity-item"  v-for="(support,index) in info.supports" :class="activityList[support.type]">
            <span class="content-tag">
  ...
  export default {
    data() {
      return {
        ...
        activityList:['activity-green','activity-red','activity-orange']
      }
    },
    computed:{
      ...mapState(['info'])
